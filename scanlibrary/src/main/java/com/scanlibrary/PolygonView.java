...
//        addView(midPointer24);
    ...
    private void initPaint() {
        ...
        paintFilled.setColor(Color.parseColor("#77FFFFFF"));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        Path path = new Path();
        path.moveTo(pointer1.getX() + (pointer1.getWidth() / 2),
                pointer1.getY() + (pointer1.getHeight() / 2));
        path.lineTo(pointer2.getX() + pointer2.getWidth()/2,
                pointer2.getY() + pointer2.getHeight()/2);
        path.lineTo(pointer4.getX() + pointer4.getWidth()/2,
                pointer4.getY() + pointer4.getHeight()/2);
        path.lineTo(pointer3.getX() + pointer3.getWidth()/2,
                pointer3.getY() + pointer3.getHeight()/2);
        path.lineTo(pointer1.getX() + pointer1.getWidth()/2,
                pointer1.getY() + (pointer1.getHeight() / 2));
